            ...
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    const provider = e.target.value as "anthropic" | "openai" | "custom";
                    setSelectedProvider(provider);
                    if (provider === "anthropic") setSelectedModel("claude-haiku-4-5-20251001");
                    else if (provider === "openai") setSelectedModel("gpt-4o");
                  }}
                  disabled={isRunning}
                  className="glass-select !w-auto !px-1.5 !text-[10px]"
                  title="API Provider"
                >
                ...
                <select
                  ...
                  onChange={(e) => {
                    if (selectedProvider === "custom") setCustomModel(e.target.value);
                    else setSelectedModel(e.target.value as ModelId);
                  }}
                  disabled={isRunning}
