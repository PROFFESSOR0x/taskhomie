...
use crate::openai_api::OpenAiApiError;
...
impl Agent {
    ...
    pub fn set_api_provider(&mut self, provider: ApiProvider) {
        self.api_provider = provider;
    }

    pub fn set_custom_base_url(&mut self, url: Option<String>) {
